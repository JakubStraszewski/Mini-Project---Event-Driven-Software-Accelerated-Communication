 ...
 * In a real-life implementation this driver would most likely perform those operations through the operating system. Here we use a different type of calls to the OS, which allow the data to be shared between components through files rather than the restriced
 * kernel mode memory.
...
public class Driver {
    /**
     *  Modify the value of this constant within the range of 1 and the number of triangulator classes to test rendering speed.
     */
    public static final int triangulatorCount = 1;
        ...
        while (globalEvent.getEventID() != 2)
        {
            ...
            switch (globalEvent.getEventID())
            {
                ...
                default:
                {
                    ...
                    status = SendEvent(new EdsacEventParameterized(0, new String[]{""}), true);
    ...
    public static DriverStatus SendEventToTriangle(EdsacEventParameterized event)
    {
    ...
    public static EdsacEventParameterized RetrieveEventFromTriangulator()
    {
